      ...
      <div class="row">
            <div class="col-md-12">
              <div class="row">
                <div class="col-md-8">
                  <fieldset>
                  <legend>Datos del nuevo artículo</legend>
                    <form  method="POST" action="../acciones.php" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" name="descripcion" cols="30" rows="10" required></textarea>
                      </div>  <!-- /Descripcion -->
                      <div class="form-group">
                      ...
                      <div  class="form-group">
                          <input type="submit" name="accion" class="btn btn-primary" value= "Registar">
